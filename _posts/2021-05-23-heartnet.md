...
![lifepak12]({{site.baseurl}}/assets/images/heartnet1/raw_ekg_data.png)

*Prior machine learning EKG classification has been done on raw EKG signals, a series of numbers like this representing voltage samples throughout the recording.  Existing heart monitors typically aren't set up to output such numbers, since they're difficult for humans to interpret.*
