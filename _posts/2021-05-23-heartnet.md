...
*Bridging the gap between research and healthcare practice for neural network heart attack detection, which could almost halve the rate of STEMI death in some EMS systems.*
